...
from nets.unet_use_lightmsffe import Unet
...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    fp16            = True                                                                     # default is False
    #-----------------------------------------------------#
    #   num_classes     训练自己的数据集必须要修改的
    #                   自己需要的分类个数+1，如2+1 1是背景
    #-----------------------------------------------------#
    num_classes = 6                                                                       # 训练自有数据集必须修改
    #-----------------------------------------------------#
    #   主干网络选择
    #   vgg
    #   resnet50
    ...
    #                   使用ghostnet时，全部选False，此时加载主干网络的权重。
    #----------------------------------------------------------------------------------------------------------------------------#
    pretrained  = False
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    Init_Epoch          = 0
    Freeze_Epoch        = 50
    Freeze_batch_size   = 4                                                        # default is 2
    #------------------------------------------------------------------#
    #   解冻阶段训练参数
    ...
    #------------------------------------------------------------------#
    UnFreeze_Epoch      = 100
    Unfreeze_batch_size = 4                                                        # default is 2
    #------------------------------------------------------------------#
