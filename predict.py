...
if __name__ == "__main__":
    ...
    # name_classes    = ["Background", "Car", "Low vegetation", "Tree", "Building", "RImpervious surfaces"]
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval = 100
    fps_image_path  = r"D:\PyCharm\UNet\test_data\test1.png"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        # 多张预测
        input_path = r'E:\issue_postprocess_data\Road-Extraction-master\dataset\test'
        output_path = r'E:\issue_postprocess_data\Road-Extraction-master\unet_res'
        ...
        for img in tqdm.tqdm(imgs):
            ...
            try:
                ...
                print(f"图片打开失败 {img}: {e}")
                continue

            r_image = unet.detect_image(image, count=count, name_classes=name_classes)

            filename, _ = os.path.splitext(img)
            save_path = os.path.join(output_path, filename + '.png')
