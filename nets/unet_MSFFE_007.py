...
# 使用添加PPM模块的MSFFE
# from nets.MSFFE_fusion import MSFFE_PPM_Fusion, MSFFE_PPM_Model     # 1
from nets.MSFFE_fusion_DenseASPP import MSFFE_DenseASPP_Model     # 2
...
class Unet(nn.Module):
    def __init__(self, num_classes=21, pretrained=False, backbone='resnet50'):
        ...
        # 使用不同的融合模块
        # self.msffe = MSFFE_PPM_Model()              # 1
        self.msffe = MSFFE_DenseASPP_Model()      # 2
